                ...
                <div class="row">
                    <div id="tabs-modern" >
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item" role="presentation" ><a class="nav-link active show" href="./USER_Member_3" data-bs-toggle="tab" aria-selected="true" role="tab">詳情</a></li>
                            ...
                            <li class="nav-item" role="presentation" ><a class="nav-link " href="./USER_Member_2" data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab">刪除</a></li>
                        </ul>                    
                    </div>
                </div>
                <!-- Owl Carousel-->
