...
let Search_level = "0";
if(path == '/User/USER_Member_3'){
    Search_level = "3";
}
else if(path == '/User/USER_Member_4'){
    Search_level = "4";
}
else if(path == '/User/USER_Member_2'){
    Search_level = "2";
}
else if(path == '/User/USER_Member_1'){
    Search_level = "1";
}
else if(path == '/User/USER_Member_0'){
    Search_level = "0";
}
